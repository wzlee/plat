 ...
 * @since 2013-12-06
 */
public class BuyerOrderEvaluationSyncBean extends AbstractSyncBean<OrderEvaluation> {

	public BuyerOrderEvaluationSyncBean(OrderEvaluation syncObj, SyncType syncType) {
	...
	protected void buildingBean(OrderEvaluation syncObj) throws Exception {
		...
		selectSql = "SELECT oe.*,u.uid,o.oid FROM orderevaluation oe,user u,goodsorder o WHERE oe.user_id = u.id AND"
				+" oe.order_id = o.id AND oe.oeid = '"+uniqueKeyValue+"'";
