...
Ext.define('plat.model.enteruser.EnterModel', {
    ...
    fields: [
    		...
    		{name:'enterprise.enterpriseIndustry',type:'int'},
    		...
    		{name:'enterprise.status',type:'int'},
    		{name:'enterprise.city',type:'Integer'},
    		{name:'enterprise.district',type:'Integer'},
    		{name:'enterprise.orgIndustry',type:'Integer'},
    		{name:'enterprise.orgProperty',type:'Integer'},
    		{name:'enterprise.business',type:'String'},
    		{name:'enterprise.advantageServiceAreas',type:'String'},
    		{name:'enterprise.totalAssets',type:'double',defaultValue:0},
    		{name:'enterprise.profit',type:'double',defaultValue:0},
    		{name:'enterprise.honorSociety',type:'String'},
    		{name:'enterprise.professionalQualifications',type:'String'},
    		{name:'enterprise.legalPerson',type:'String'},
    		{name:'enterprise.legalRepresentativeMobile',type:'String'},
    		{name:'enterprise.generalName',type:'String'},
    		{name:'enterprise.generalManagerMobile',type:'String'},
    		{name:'enterprise.generalManagerEmail',type:'String'},
    		{name:'enterprise.linkman',type:'String'},
    		{name:'enterprise.contactNameMobile',type:'String'},
    		{name:'enterprise.contactNameEmail',type:'String'},
    		{name:'enterprise.orgFax',type:'String'},
    		{name:'enterprise.orgWebsite',type:'String'}
    	]
});
