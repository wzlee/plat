    ...
    a.fn.passwordStrength = function(b) {
        ...
        this.each(function() {
            ...
            function() {
                ...
                e >= 0 && c == false && (c = true);
                f.find("span").removeClass("c1");
                f.find("span").removeClass("c2");
                f.find("span").removeClass("c3");
                if (e < 35 && e >= 0) {
                    f.find("span:first").addClass("c1")
                } else {
                    if (e < 60 && e >= 35) {
                    	f.find("span:first").addClass("c1")
                        f.find("span:eq(1)").addClass("c2")
                    } else {
                        if (e >= 60) {
                        	f.find("span:first").addClass("c1")
                        	f.find("span:eq(1)").addClass("c2")
                            f.find("span:eq(2)").addClass("c3")
                        }
                    }
                }
