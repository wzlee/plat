	 	...
	 	$('#my-appeal').datagrid({
	        ...
	        columns:[[ 
	            ...
	            {field:'buyer',title:'买家',width:101,align:'center',
	            	formatter:function(value,rowData,rowIndex){
	            		if(rowData.goodsOrder.orderSource == 1){
	            			if(rowData.goodsOrder.buyer){
		            			return rowData.goodsOrder.buyer.enterprise.name;
	            			}else{
	            				return rowData.goodsOrder.staff.parent.enterprise.name;
	            			}
	            		}else if(rowData.goodsOrder.orderSource == 2){
	            			if(rowData.goodsOrder.buyer){
	            				return rowData.goodsOrder.biddingService.user.enterprise.name;
	            			}else{	
	            				return rowData.goodsOrder.biddingService.staff.parent.enterprise.name;
	            			}
	            		}	
	            	}
	            },
