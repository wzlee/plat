...
<title>找回密码-深圳市中小企业公共服务平台</title>
...
<script type="text/javascript" src="resources/js/main/find_password.js"></script>
...
<div class="register-content">
	...
	<div class="control-group">
        ...
        <div class="controls"><input type="text" name="username" id="username" value="" class="xxlarge" /></div>
    </div>
    <div class="control-group">
        <label class="control-label" for="username">电子邮箱：</label>
        <div class="controls"><input type="text" name="email" id="email" value="" class="xxlarge" /></div>
    </div>
    <div class="control-group">
