...
<div class="search-wrap">
  ...
  <div class="sortbar">
    <ul class="nav-pills">
      <!-- <li class="active"><a href="">申请数<i class="up"></i></a></li>
      <li><a href="">评价<i class="down"></i></a></li>
      <li><a href="">时间<i class="down"></i></a></li>
      <li><a href="javascript:void(0)">价格<i class="down"></i></a></li> -->
    ...
    <ul class="switch-control">
      <li class="s1"><a href="javascript:void(0)">大图</a></li>
      <li class="s2-on"><a href="javascript:void(0)">列表</a></li>
    </ul>
  ...
  <div class="search-items">
  	<c:forEach items="${serviceViews}" var="serviceView">
	      ...
	      <div class="col pic"><a href="service/detail?id=${serviceView.id}" target="_blank">
	      	<c:if test="${serviceView.picture.contains('http')}">
	      		<img src="${serviceView.picture}" width="168" height="143" onerror="this.src='resources/images/service/default_service_pic.gif'"/> 
	      	</c:if>
	     	<c:if test="${!serviceView.picture.contains('http')}">
	      		<img src="upload/${serviceView.picture}" width="168" height="143" onerror="this.src='resources/images/service/default_service_pic.gif'"/> 
	      	</c:if>
	      ...
	      <div class="col title">
	        <h3 class="summary"><a href="service/detail?id=${serviceView.id}" target="_blank">${serviceView.serviceName}</a></h3>
	        <div class="info clearfix">
	          ...
	          <div class="apply-info">已申请：<span>${serviceView.serviceNum}</span></div>
	        </div>
	        <%
	        	/* 截取服务介绍字符串,并去掉html标签 */
	      ...
	      <div class="col company">
	        <h4 class="name"><a href="">${serviceView.enterpriseName}</a></h4>
	        <div class="extend">
	      ...
	      <div class="col end apply-service"><a class="apply-btn" href="service/detail?id=${serviceView.id}" target="_blank">查看详情</a></div>
	    </div>
  	</c:forEach>
    <div class="plist">
    	<c:if test="${total>0}">
