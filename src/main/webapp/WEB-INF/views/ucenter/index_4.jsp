    ...
    <div class="main-column">
		<div class="">
		    ...
		    <!-- <div class="identi-block">
	            <p>您还未申请用户实名认证，认证成功后方可在平台申请服务...</p>
	                <a href="ucenter/auth_form3?op=2" class="user-btn">申请实名认证</a>
		    </div> -->
	            ...
	            <table class="auth-grid" width="100%" border="0" cellpadding="0" cellspacing="0">
	                ...
	                <tbody>
	                  <tr>
	                    ...
	                    <td>
	                    	<p><a href="ucenter/auth_form3"></a></p>
	                    </td>
	                  </tr>
	                </tbody>
	            </table>
       ...
       <!-- /order-info -->
        <div class="recommend-service">
           <h3 class="common-head">推荐服务<a href="javascript:void(0);" class="a-link interesting_a">我感兴趣的领域</a><a href="javascript:void(0);" class="expre fr"><img src="resources/images/ucenter/user-ex.png" alt="" /></a></h3>
