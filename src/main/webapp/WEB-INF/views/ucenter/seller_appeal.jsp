...
<div class="main-container">
    ...
    <div class="main-column">
        <h3 class="top-title">卖家管理中心>申诉管理</h3>
		...
		<div title="我的申诉" style="padding:10px">
			...
			<table id="my-appeal"style="width:750px;height:524px"></table>
		</div>
...
<script type="text/javascript" src="resources/js/ucenter/seller_appeal.js"></script>
</body>
</html>