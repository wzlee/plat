 ...
 <div class="sortbar mt-110">
    <ul class="nav-pills search-drop">
      ...
      <li class="result-search">
        ...
        <input type="text" name="name"  class="pri keywords"  value="${name}" placeholder="在结果中搜索"/>
    ...
    <ul class="switch-control">
      <li class="s1"><a href="enter/list?cid=${cid}&pageType=0">大图</a></li>
      <li class="s2-on"><a href="javascript:void(0)">列表</a></li>
    </ul>
    <ul class="page-control">
      <li class="s1-on"><a href="javascript:void(0);">后退</a></li>
      <li class="s2"><a href="javascript:void(0);">前进</a></li>
    </ul>
    </div>
  </div>		
		  		...
		  		<c:forEach items="${enterprises}" var="enterprise" varStatus="status">
				    <div class="list-view">
				      ...
				      <div class="col company com-s">
				        <h3 class="name"><a href="enter/queryEnter?eid=${enterprise.id}" target="_blank">${enterprise.name}</a></h3>
				        <div class="extend">
...
<!-- 				          <div class="online-consultation"><a href="">在线咨询</a></div> -->
				      ...
				      <div class="col end apply-service"><a href="enter/queryEnter?eid=${enterprise.id}" target="_blank">进入机构主页</a></div>
				    </div>
		  		</c:forEach>
		    </div>			
		</div>
