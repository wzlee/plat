...
<meta charset="UTF-8">
<base href="<%=basePath%>">
<title>服务机构二级分类-深圳中小企业服务平台</title>
...
<div class="container">
		<div class="panel">
			<ul class="second-column">
				<c:forEach items="${orgSubCategoryList }" var="orgSubCategoryItem">
					<li><a href="wxpage/orgList?id=${orgSubCategoryItem.id }">${orgSubCategoryItem.text }</a></li>
				</c:forEach>
			</ul>
		</div>		
</div>
