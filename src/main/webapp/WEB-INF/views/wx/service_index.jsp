...
<div class="container">
		<div class="panel">
			<ul class="columns">
				...
				<c:forEach varStatus="image" items="${serviceCategroyList }" var="serviceCategoryItem">
					<li>
						<a href="wxpage/middleService?id=${serviceCategoryItem.id }"><div class="panels">
						<img src="resources/images/${imageList[image.index]}" alt="">
						<h3>${serviceCategoryItem.text }</h3>
					</div></a>
				</li>
				</c:forEach>														
			</ul>
