...
Ext.define('Ext.ux.form.HtmlEditor.imageUpload', {
    ...
    lang: {
        ...
        'Your photo has been uploaded.': '你的图片已上传成功',
        'Real Size': ''
    },
...
//                    name: 'photo-path',
    ...
    getImage: function () {
        ...
        // set image attrs
        image.setAttribute('src', 'upload/' + values['src']);
        ...
        if (form.isValid()) {
            form.submit({
                ...
                success: function (fp, o) {
                    ...
                    combo.setRawValue(o.result.message);
                    me._setPreviewImage(o.result.message, true);
                },
                failure: function (form, action) {
                    if (action.result) {
                    	/*Ext.Msg.alert(me.t('Error'), 'Error: ' + action.result.errors);*/
                    	Ext.Msg.alert(me.t('Error'), 'Error: ' + action.result.message);
                    }
